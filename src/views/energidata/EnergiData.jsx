...
return (
    ...
    <h1 className='my-6 text-3xl font-bold text-center'>Energi Priser</h1>
  ...
  <div className='my-4 px-10'>
    <h3>
      <small>Data fra energi priser API:</small>
    </h3>
  </div>
  ...
  <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3 pb-24 px-10">
